...
mod tests {
    ...
    fn optimizer_reduces_cleared_transfer_count() {
        ...
        let trades = vec![
            Trade { trade_id: 1, pair: pair.clone(), price: PRICE_SCALE, quantity: 10, buyer_id: "A".into(), seller_id: "B".into(), buy_order_id: 1, sell_order_id: 2 },
            Trade { trade_id: 2, pair: pair.clone(), price: PRICE_SCALE, quantity: 10, buyer_id: "B".into(), seller_id: "C".into(), buy_order_id: 3, sell_order_id: 4 },
            Trade { trade_id: 3, pair: pair.clone(), price: PRICE_SCALE, quantity: 10, buyer_id: "C".into(), seller_id: "A".into(), buy_order_id: 5, sell_order_id: 6 },
        ];
