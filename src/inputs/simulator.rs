...
//! `data/SCHEMA.md`) into `crate::types::Order` values that can be fed
//! straight into either engine's orderbook (`FbaOrderBook::submit` /
//! `CdaOrderBook::submit`).
//!
...
//! pure-integer arithmetic (no floats, matching this project's pricing
//! discipline) rather than parsing through `f64`.
